...
I listed some caveats for you to avoid, so that you won't get frustrated using my method and write a long complaining letter to you grandma and your grandma give me a 5 hours phone call about her concerns　  (´ ▽ `)b （´∀｀*)ﾉ
...
Standardizing the features is strongly recommended to makes the learning easier (This can be easily done with the StandardScaler() from the sklearn package). 
